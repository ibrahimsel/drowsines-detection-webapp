...
uploaded_file = st.file_uploader(
    "Lütfen bir fotoğraf yükleyiniz", type=["jpg", "jpeg", "png"])
        ...
        with mp_face_mesh.FaceMesh(
            ...
            if results.multi_face_landmarks:
                for face in results.multi_face_landmarks:
                    ...
                    cropped_eye_left = annotated_image[e[285]
                                                       [1]:e[346][1], e[285][0]:e[346][0]]
                ...
                st.write(
                    "Yüz tespit edilemedi. Yüz hatları belirgin bir fotoğraf yükleyiniz")
    except Exception:
        st.write(
            "Fotoğraf kaynaklı bir sorun oluştu. Lütfen başka bir fotoğraf yükleyiniz")
else:
